  ...
  render() {
    return (
      <div className="container"> 
        ...
        <span className="container1"> <h1>Growths </h1><Growths growth={this.state.growth}/> </span>
        <span className="container1"> <h1>Skills </h1><Skills skill={this.state.skill} /> </span>
        <span className="container1"><h1>Experience</h1><Experiences experience={this.state.experience} /> </span>
        <span className="container1"><h1>Education</h1><Educations education={this.state.education} /> </span>
        <span className="container1"><h1>Achievements</h1><Achievements achievement={this.state.achievement} /> </span>
        <span className="container1"><h1>Extracurriculars</h1><Extracurricular extracurricular={this.state.extracurricular} /> </span>
      </div>
    )
  }
}
